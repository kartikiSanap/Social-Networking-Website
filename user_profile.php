...
<body>
  ...
  <div class="col-sm-12">
      ...
      <center>
        <div style='background-color:#e6e6e6;'class='col-sm-3'>
          ...
          <ul class='list-group'>
            ...
            <li class='list-group-item' title='User Registration '><strong style='color:grey;'>$register_date</strong></li>
    ...
    ?>
    <div class="col-sm-8">
      <center><h1><strong><?php echo"$f_name $l_name";?> posts</strong></h1></center>
      <?php
      global $con;
      if(isset($_GET['u_id'])){
        $u_id=$_GET['u_id'];
